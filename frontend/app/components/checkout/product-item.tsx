...
export function ProductItem({ image, title, rating, price, originalPrice }: ProductItemProps) {
  return (
    <div className="flex gap-6 py-6 border-b border-gray-100 last:border-b-0">
      <img
        src={image || "/placeholder.svg?height=120&width=120"}
        alt={title}
        className="w-28 h-28 object-cover rounded-lg flex-shrink-0 bg-gray-100"
      />
