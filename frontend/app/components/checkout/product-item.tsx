...
export function ProductItem({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 py-4 sm:py-6 border-b border-gray-100 last:border-b-0 ">
      <img
      ...
      <div className="flex-1 flex flex-col justify-between">
        ...
        <div className="flex items-start justify-between mt-4 flex-col gap-2">
